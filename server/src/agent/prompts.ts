...
返回格式（严格 JSON）：
{
  ...
  "tracks": [
    {
      "trackId": 歌曲ID（数字）,
      "segue": "上一首到这首的过渡词（60-120字，承接情绪并带出下一首）",
      "djScript": "DJ 解说词（70-140字，介绍歌曲、艺人或声音气质）",
      "recommendReason": "推荐理由（70-140字，解释为什么适合当前场景、心情和用户品味）"
    }
  ]
}
...
- 可以选择少量 sourceScope=explore 的探索歌曲，但不要超过队列的 25%
- 如果选择探索歌曲，recommendReason 必须说明它不只是新歌，而是如何延展用户的常听气质、当前场景或心情
- 不要选黑名单中的歌曲
- 每首歌都要有足够完整的 DJ 独白内容，不能只写“下一首”“继续”“开场”
